...
try:  # Compatibilité avec les versions 1.x du SDK OpenAI.
    from openai import OpenAI
except ImportError:  # pragma: no cover - dépend du SDK installé sur Streamlit Cloud.
...
def main() -> None:
    ...
    else:  # Compatibilité avec les anciennes versions du SDK
